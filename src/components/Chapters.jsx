...
const chapters = [
  ...
  { year: 1, quarter: 3, startMonth: 6,  endMonth: 8,  icon: 'explore',       title: 'Por escribir' },
        ...
        {chapters.map((c) => {
          ...
          return (
            <div
              ...
              className={[
                'p-4 rounded-xl flex flex-col items-center text-center gap-2 border transition-all',
                completed
